...
docs_impact: "none"
linked_systems:
  - "src/ui/temu-shell/components/MobileLayout.vue"
  - "src/ui/temu-shell/components/AppSidebar.vue"
...
evidence:
  ...
  - "Code inspection found the real home surface in src/ui/temu-shell/components/MobileLayout.vue and desktop list/session navigation in AppSidebar.vue."
next_step: "/104-sf-end Remasteriser l'accueil autour des listes shopping"
---
...
- `src/ui/temu-shell/components/MobileLayout.vue`: home hierarchy, list section, compact list creation, compact session creation, utility links.
- `src/ui/temu-shell/components/AppSidebar.vue`: first-class shopping-list sidebar section and list creation shortcut.
- `src/ui/temu-shell/style.css`: responsive layout, list cards, icon buttons, compact empty states, sidebar list styling.
...
- [x] Task 1: Move home list state into the shell home component.
  - File: `src/ui/temu-shell/components/MobileLayout.vue`
...
- [x] Task 3: Promote lists in desktop sidebar.
  - File: `src/ui/temu-shell/components/AppSidebar.vue`
...
- `src/ui/temu-shell/components/MobileLayout.vue` now renders `Listes shopping` as the first home section with compact list cards, local list creation, and manual import/sync as secondary actions.
