...
linked_systems:
  - "shipflow_data/workflow/specs/temu-price-availability-observations.md"
  - "src/stores/productObservations.ts"
  - "src/pages/ProductDetailPage.vue"
  - "src/pages/ListDetailPage.vue"
  - "src-tauri/plugins/android-temu-webview"
depends_on:
  - artifact: "shipflow_data/workflow/specs/temu-price-availability-observations.md"
    artifact_version: "1.0.0"
...
- Focused tests:
  ...
  - `src/stores/productObservations.test.ts`
  - `src/stores/localPersistence.test.ts`
  - `src/stores/cloudSyncStoreIntegration.test.ts`
