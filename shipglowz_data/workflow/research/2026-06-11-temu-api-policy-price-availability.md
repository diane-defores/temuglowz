...
depends_on:
  ...
  - artifact: "shipglowz_data/workflow/research/2026-06-10-temu-webview-embedding.md"
    artifact_version: "1.0.0"
...
- `shipglowz_data/workflow/TASKS.md` - confirms `TASK-2026-06-10-013`: price and availability history is already a deferred follow-up.
